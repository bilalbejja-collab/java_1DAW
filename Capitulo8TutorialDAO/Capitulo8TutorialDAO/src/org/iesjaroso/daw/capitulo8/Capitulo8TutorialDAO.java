...
import org.iesjaroso.daw.capitulo8.model.User;

/**
 *
 * @author franmatias
 */
public class Capitulo8TutorialDAO {
...
GRANT ALL ON javabase.* TO 'java'@'localhost' IDENTIFIED BY 'd$7hF_r!9Y';    
     ...
     * 'javabase'.
     * <li>A 'user' table in the 'javabase' database which is created as
     * follows:
     * <pre>
     * CREATE TABLE javabase.user (
     *     id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
     ...
     * <li>A properties file 'dao.properties' in the classpath with the
     * following entries:
     * <pre>
    ...
    public static void main(String[] args) {
        ...
        user.setBirthdate(LocalDate.parse("1999-03-26"));
        userDAO.create(user);
        ...
        anotherUser.setBirthdate(LocalDate.parse("1978-03-26"));
